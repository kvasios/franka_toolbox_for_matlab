/*
 * franka_robot_model_pose_sfunction.cpp - C++ Level-2 S-Function
 *
 * Computes the 4x4 pose transformation using libfranka's Model class.
 *
 * Parameters:
 *   0. frame - 0-6 = Joint1-7, 7 = Flange, 8 = EndEffector, 9 = Stiffness
 *
 * Inputs:
 ...
 *
 * Outputs:
 *   0. pose     (4x4 double)  - Pose transformation matrix
 *
 * Copyright (c) 2025 Franka Robotics GmbH
 */

#define S_FUNCTION_NAME  franka_robot_model_pose_sfunction
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    /* Port 0: pose (4x4) */
    ssSetOutputPortMatrixDimensions(S, OUT_POSE, 4, 4);
    ssSetOutputPortDataType(S, OUT_POSE, SS_DOUBLE);
...
{
    real_T *pose = ssGetOutputPortRealSignal(S, OUT_POSE);
